...
from tsumtsum_analyze.extractor import SamplePoint, VideoInfo, format_timecode, write_image
from tsumtsum_analyze.fs import kind_dir
from tsumtsum_analyze.scene_labels import OTHER_KEY, SceneLabels, scene_model_path, scene_model_ready
...
def extract_scene_frames(
    ...
    from tsumtsum_analyze.extractor import grab_frame
