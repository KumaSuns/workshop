...
from app.item_slots import crop_box
...
def use_tsums_root() -> Path:
    return Path(__file__).resolve().parent / "assets" / "images" / "use_tsums"


def _models_root() -> Path:
    return Path(__file__).resolve().parent / "assets" / "models" / "use_tsum"
